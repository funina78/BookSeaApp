...
import webapp.model.CommentManager;
import webapp.model.Book;
import webapp.model.Comment;
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(r != null){
                ...
                ArrayList<Comment> comments = cm.getCommentByBookId(book_id);

                request.setAttribute("comments", comments);
                request.setAttribute("title", r.getName());

            } else {
                url = "/feedback.jsp";
                request.setAttribute("title", "Ooops");
                request.setAttribute("feedback_message", "Sorry, we could not find the book.");
            }
